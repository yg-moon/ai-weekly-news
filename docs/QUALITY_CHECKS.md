...
| `docs/QUALITY_CHECKS.md` | 200줄 | 검사 항목이 늘기만 했는지 5절에서 본다 |
...
- 검사 항목이 늘기만 하지 않는가. 두 번 연속 아무것도 안 걸린 항목은 지우는 쪽을 고려한다.
- 점검한 날짜와 고친 것을 [`../PLAN.md`](../PLAN.md) 에 한 줄로 남긴다.
